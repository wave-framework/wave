...
class Action
{
    ...
    public function getRespondsWith()
    {
    ...
    public function setSchedule($schedule_expression)
    {
        $this->schedule = $schedule_expression;
    }
    ...
    public function hasScheduleTimezone()
    {
        return isset($this->schedule_timezone);
    }
